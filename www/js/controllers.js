...
vmaControllerModule.controller('groupFeed', ['$scope', '$state', '$modal', 'snapRemote', 'vmaGroupService', '$timeout', function($scope, $state, $modal, snapRemote, vmaGroupService, $timeout) {
